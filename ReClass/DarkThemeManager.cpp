...
IMPLEMENT_DYNCREATE(CMFCDarkThemeManager, CMFCVisualManagerOffice2007);

CMFCDarkThemeManager::CMFCDarkThemeManager()
{
    SetStatusBarOfficeXPLook(FALSE);
    CMFCButton::EnableWindowsTheming(FALSE);
}

void CMFCDarkThemeManager::OnUpdateSystemColors()
{
    //CMFCVisualManagerOffice2007::OnUpdateSystemColors();
    //return;
    const COLORREF NotSet = RGB(220, 220, 220);
    ...
    GetGlobalData()->clrBtnHilite = RGB(46, 46, 46);
    ...
    GetGlobalData()->clrGrayedText = RGB(170, 170, 170);
    ...
    GetGlobalData()->clrBarHilite = RGB(80, 80, 80);   // Shadow on toolbar separator
    GetGlobalData()->clrBarDkShadow = RGB(31, 31, 31);  // Properties group / right side of tab shadow
    ...
    GetGlobalData()->clrActiveCaption = RGB(41, 41, 41);
    GetGlobalData()->clrInactiveCaption = RGB(41, 41, 41);
    GetGlobalData()->clrInactiveCaptionText = RGB(210, 210, 210);
    ...
    m_clrHighlightMenuItem = RGB(61, 61, 61);
    ...
    m_clrMainClientArea = RGB(46, 46, 46);
    ...
    m_brGroupBackground.CreateSolidBrush(RGB(46, 46, 46));
}